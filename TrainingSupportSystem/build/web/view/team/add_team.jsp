    ...
    <head>
        ...
        <script>
            function f1() {
                ...
                var e = document.getElementById('class_id_ajax');
                var value = e.value;
                $.ajax({
                    url: 'add_team_ajax',
                    type: "POST",
                    ...
                    success: function (data) {
                        var content = document.getElementById('mile_id_ajax');
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <br/>
                                                    <select id="class_id_ajax" onchange="f1()" style="height:35px;width: 150px;text-align: center;border-radius: 10px" name = "class_id">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <br/>
                                                    <select id=mile_id_ajax style="height:35px;width: 150px;text-align: center;border-radius: 10px" name = "milestone">
