...
public class ClassListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            case "add":
                ...
                request.setAttribute("setting_per1", clDB.listAllClass());
    ...
    protected void listClass(HttpServletRequest request, HttpServletResponse response)
        ...
        int page_size = 5;
        int count = clDB.count(supporter_id, trainer_id, class_id, status);
        ...
        ArrayList<model.Class> classlist = clDB.paggingV2(page_size, page_index, supporter_id, trainer_id, class_id, status);
    ...
    public void classEdit(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("classlist?action=edit&class_id=" + clas_id);
    }
