...
<html lang="en">
    ...
    <head>
        ...
        <script src="assets/js/pagger_class.js" type="text/javascript"></script>
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            ...
                                            <select name="class_get" class="select-1">
                                                ...
                                                <c:forEach items="${requestScope.setting_per}" var="s">
                                                    <option <c:if test="${s.class_id == clas}">selected=""</c:if>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="d-md-flex align-items-center text-center justify-content-between">
                                                ...
                                                <ul id="only-pagger" class="pagination justify-content-center mb-0 mt-3 mt-sm-0">
                                                    <script>
                                                        render("only-pagger",${page_index},${total_page}, 2,${sup},${train},${cla},${status});
                                                    </script>
                                                </ul>
                                            </div>
                                        </div><!--end col-->
