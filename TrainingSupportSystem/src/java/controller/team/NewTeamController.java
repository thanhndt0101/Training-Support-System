...
//        request.getRequestDispatcher("view/team/list_team.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String class_id = request.getParameter("class");
        String excelFilePath = "D:\\img\\"+s;
        List<Team> class_user = readExcel(excelFilePath);
        HttpSession session = request.getSession();
  ...
  private static final long serialVersionUID = 1L;
    ...
    public static List<Team> readExcel(String excelFilePath) throws IOException {
        List<Team> classList = new ArrayList<>();
        // Get file
        ...
        while (iterator.hasNext()) {
            ...
            Team cl = new Team();
            ArrayList<Team_member> Listtm = new ArrayList<>();
            ...
            while (cellIterator.hasNext()) {
                ...
                switch (columnIndex) {
                    ...
                    case COLUMN_INDEX_PRICE:
                        cl.setTeam_id(new BigDecimal((double) cellValue).intValue());
