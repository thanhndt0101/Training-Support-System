            ...
            case "upload": {
                try {
                    ...
                    if (filename.equals("")) {
                        ...
                        Path imagesPath = Paths.get("C:\\swp\\project18\\g1\\TrainingSupportSystem\\build\\web\\images\\" + user.getAvatar_url());
                        try {
    ...
    protected void upload(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (filename.equals("")) {
                ...
                Path imagesPath = Paths.get("D:\\Backup-last\\g1\\TrainingSupportSystem\\build\\web\\images\\" + user.getAvatar_url());
                try {
                    Files.delete(imagesPath);
