...
public class TeamListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String team_lead = request.getParameter("teamlead");
        if(leader!=null && team_lead!=null){
            t.UpdateLeader(leader, team_lead);
        List<Team_member> list= t.getTeamMemberById(Integer.parseInt(leader),Integer.parseInt(team_lead) );
        for (int i = 0; i < list.size(); i++) {
            t.EditLeader(list.get(i));
        }
        }
        ...
        List<Milestone> listMileStone = t.getAllMileStoneByClassId("1");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String class_id = request.getParameter("subject_id");
        List<Milestone> listMileStone = t.getAllMileStoneByClassId(class_id);
